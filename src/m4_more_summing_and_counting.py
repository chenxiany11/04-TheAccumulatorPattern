...
def run_test_factorial():
    ...
    # Test 4:
    answer_from_oracle = math.factorial(35)
    answer_from_my_code = factorial(35)
...
def run_test_count_cosines_from():
    ...
    # Test 2:
    answer_from_by_hand = 1
    answer_from_my_code = count_cosines_from(3, 5, 0)
    print('Test 2 expected (from oracle):', answer_from_by_hand)
    print('       actual (from my code): ', answer_from_my_code)

    # Test 3:
    answer_from_by_hand = 3
    answer_from_my_code = count_cosines_from(4, 9, 0)
    print('Test 3 expected (from oracle):', answer_from_by_hand)
    print('       actual (from my code): ', answer_from_my_code)

    # Test 4:
    answer_from_by_hand = 2
    answer_from_my_code = count_cosines_from(3, 6, 0.1)
    print('Test 4 expected (from oracle):', answer_from_by_hand)
    print('       actual (from my code): ', answer_from_my_code)

    # Test 5:
    answer_from_by_hand = 4
    ...
    print('Test 6 expected (from oracle):', answer_from_by_hand)
    print('       actual (from my code): ', answer_from_my_code)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 0.745635   # This is APPROXIMATELY the correct answer.
